...
public class PlayerJumpCount : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        if (isGrounded || isWallSliding) jumpCount = 0;
    }

    public void OnJumpStarted()
    {
        if (isGrounded || isWallSliding || jumpCount < JumpMaxCount - 1)
        {
            SetGravity();
            Jump();
    ...
    private void SetGravity()
    {
        ...
        gravity += (gravity * 0.25f * jumpCount);
